		...
		<cfoutput>
            ...
            <div class="post">
             <div class="post-header">
              <h1 class="post-title"><a href="#application.blog.makeLink(id)#">#title#</a></h1>
			  
			  <div class="metadata">
			   <!---Posted on--->
			   Created on #dateFormat(posted, "mm/dd/yyyy")# at #timeFormat(posted,'hh:mm tt')# | 
                <cfif len(name)>by <a href="#application.blog.makeUserLink(name)#">#name#</a></cfif> in
			   	</cfoutput>
			    ...
			    <div class="share">
					<div class="addthis_toolbox addthis_default_style">
						<a class="addthis_button_tweet" addthis:url="#application.blog.makeLink(id)#" addthis:title="#title#"></a>
						<a class="addthis_button_facebook_like" fb:like:layout="button_count" addthis:url="#application.blog.makeLink(id)#" addthis:title="#title#"></a>
					</div>
					<script type="text/javascript">var addthis_config = {"data_track_clickback":true};</script>
					<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js##pubid=ra-4e7290917a7182d8"></script>				
					<!-- Place this tag where you want the +1 button to render -->
					<g:plusone size="medium" href="#application.blog.makeLink(id)#"></g:plusone>
				</div>
             ...
             <div class="post-content clearfix">
					#application.blog.renderEntry(body,false,enclosure,true)#
					...
					<p align="right">
					<a href="#application.blog.makeLink(id)###more">Continue Reading >></a>
					</p>
					<cfelseif len(morebody)>
					#application.blog.renderEntry(string=morebody,ignoreParagraphFormat=true)#
					</cfif>

					<div class="clear">&nbsp;</div>					
					
					<p class="post-metadata">
					This entry was posted on #dateFormat(posted, "mmmm d, yyyy")# at #timeFormat(posted, "h:mm tt")# and has received #views# views. <a href="#application.blog.makeLink(id)###comments">Comments <cfif commentCount is "">0<cfelse>#commentCount#</cfif></a> |  
