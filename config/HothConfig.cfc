...
component
	...
	property name='applicationName'			default='toysforshots';
	...
	property name='logPath' 				default='/toysforshots/logs';
	...
	property name='EmailNewExceptionsTo' 	default='danvega@gmail.com';

	/** What address would you like these emails sent from? */
	property name='EmailNewExceptionsFrom' 	default='danvega@gmail.com';
